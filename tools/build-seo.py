...
PDF = 'Nepravidelna-slovesa-prehled.pdf'  # generuje tools/build-pdf.sh
  ...
  <main class="container">
    <article>
      ...
      <section class="seo-pdf-section">
        <h2 id="pdf">Nepravidelná slovesa ke stažení v PDF</h2>
        <p>
          Celou tabulku {TOTAL} nepravidelných sloves si můžeš
          <strong>zdarma stáhnout v PDF</strong> — přehledně po skupinách,
          s barevně vyznačenou změnou v každém slově. Ideální na tisk
          do sešitu i na učení offline.
        </p>
        <a class="seo-pdf-download" href="/{PDF}" download data-track="pdf_seznam">
          ...
          <span class="seo-pdf-text">
            <strong>Stáhnout přehled v PDF</strong>
            <span>Všech {TOTAL} sloves ve skupinách — na tisk i offline</span>
          </span>
  ...
  <main class="container">
    <article>
      ...
      <section class="seo-pdf-section">
        <h2 id="pdf">Nepravidelná slovesa ke stažení v PDF</h2>
        <p>
          Nejen tuhle skupinu, ale <strong>celou tabulku {TOTAL} sloves</strong>
          si můžeš zdarma stáhnout v PDF — přehledně po skupinách, s barevně
          vyznačenou změnou v každém slově. Na tisk do sešitu i na učení offline.
        </p>
        <a class="seo-pdf-download" href="/{PDF}" download data-track="pdf_skupina_{sub_slug}">
          <span class="seo-pdf-ico" aria-hidden="true">
            <svg viewBox="0 0 32 32" width="38" height="38">
              <rect x="5" y="2" width="22" height="28" rx="3" fill="#ffffff" stroke="#e0dcd3" stroke-width="1.4"/>
              <path d="M20 2v6h7" fill="none" stroke="#e0dcd3" stroke-width="1.4"/>
